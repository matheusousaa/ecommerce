          ...
          <div class="p-6 space-y-6">
            ...
            <div>
              ...
              <textarea id="description" v-model="form.description" rows="4"
                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary sm:text-sm"
                :class="{ 'border-red-300': errors.description }" placeholder="Enter product description"
                required></textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="number" id="quantity" v-model="form.quantity" min="0"
                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary sm:text-sm"
                  :class="{ 'border-red-300': errors.quantity }" placeholder="Enter stock quantity" required />
              ...
              <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div class="space-y-1 text-center">
                  <div v-if="imagePreview" class="mb-4">
                    <img :src="imagePreview" alt="Preview" class="mx-auto h-40 w-auto object-contain" />
                  </div>
                  <div v-else-if="form.image && typeof form.image === 'string'" class="mb-4">
                    <img :src="form.image" alt="Current image" class="mx-auto h-40 w-auto object-contain" />
                  </div>
                  ...
                  <div class="flex text-sm text-gray-600">
                    <label for="image-upload"
                      ...
                      <input id="image-upload" name="image-upload" type="file" class="sr-only" accept="image/*"
                        @input="form.image = $event.target.files[0]" @change="handleImageUpload" />
                    </label>
